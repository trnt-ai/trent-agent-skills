...
Read `/data/openclaw/shared/data/config.json`
...
(defaults to `/data/openclaw/shared/data/`).
...
Always write `/data/openclaw/shared/data/publish-status.json`, even on failure.
